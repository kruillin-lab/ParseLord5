    ...
    internal class SCH_Simple_ST_Heal : CustomCombo
    {
        ...
        protected override uint Invoke(uint actionID)
        {
            ...
            if (TryShieldedEmergencyAdloquium(healTarget, out var shieldedHeal))
                return shieldedHeal.RetargetIfEnabled(actionID);
        ...
        protected override uint Invoke(uint actionID)
        {
            ...
            var canEnergyDrain =
                ...
                (!SCH_AoE_DPS_EnergyDrain_Burst ||
                 ...
                 !LevelChecked(ChainStratagem));
            var canChainStratagem =
                IsEnabled(Preset.SCH_AoE_ADV_DPS_ChainStrat) && ActionWatching.NumberOfGcdsUsed > 3 && CanChainStrategem &&
