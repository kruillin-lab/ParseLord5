...
internal partial class MNK
{
    ...
    {
        // ParseLord5: prevent ST PerfectBalance charge overcap when burst-window
        // timing does not line up (pre-existing HEAD behavior, layered onto
        // upstream's restructured ShouldUsePreRoFPerfectBalance flow).
